...
- **Virtual-list internals** (`_components/virtualList/*`): height calculation, scroll restoration, realm cache. The single most complex part of the app, but **unchanged** this session — a cold review is high-effort, low change-risk.
