...
Rough priority (criticality × how much we've touched it):

- **Word/content filters** (`_actions/filters.js`, `wordFilterObservers.js`, `timelineFilterComputations.js`): regex building and per-status filter evaluation — correctness + perf.
