...
- **Service worker beyond push** (`service-worker.js`): asset precaching, fetch interception, `skipWaiting`/`claim`, versioning — relevant to post-deploy staleness; ties into the single-/multi-instance hydration workaround.
