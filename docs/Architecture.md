...
- **Timeline read paths** (`_database/timelines/pagination.js`, `lookup.js`, `getStatusOrNotification.js`): cursor/key-range pagination and read-merge logic — not yet given a focused pass (the 2026-06-13 DB review centred on lifecycle/write/cleanup).
- **API / ajax layer** and **auth / instance management**: lower criticality, stable.
