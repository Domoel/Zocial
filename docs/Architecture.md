...
> The original "always start in English" default was later refined to follow the browser language on first visit — see the **[v1.10.1] First-visit language detection** entry below.
...
### [v1.10.1] First-visit language detection — follow the browser, fall back to English
