...
export const DEFAULT_LIGHT_THEME = 'pitchblack' // theme that is shown by default
export const DEFAULT_DARK_THEME = 'pitchblack' // theme that is shown for prefers-color-scheme:dark
