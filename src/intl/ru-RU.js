export default {
  ...
  quotedYou: 'процитировал(-а) вашу запись',
  quotedPostEdited: 'отредактировал(-а) запись, которую вы процитировали',
  severedRelationships: 'Связи с {name} были удалены',
  moderationWarning: 'Вы получили предупреждение от модерации',
  annualReportReady: 'Ваш #Wrapstodon {year} готов',
  ...
  listExclusiveNotSupported: 'Этот сервер не поддерживает эксклюзивные списки.',
  deleteListTitle: 'Удалить «{title}»?',
  deleteListConfirm: 'Список «{title}» будет удалён. Аккаунты в нём не затрагиваются; если список был эксклюзивным, их записи вернутся в вашу домашнюю ленту.',
  deletedList: 'Список удалён.',
  unableToRenameList: 'Не удалось переименовать список: {error}',
  unableToUpdateList: 'Не удалось обновить список: {error}',
  unableToDeleteList: 'Не удалось удалить список: {error}',
