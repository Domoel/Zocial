...
Enable this to also include the description text below the title.`,
  ...
  notifyOnThisDevice: 'Notify me on this device',
  notifyOnThisDeviceDescription: "Get notifications from your operating system — on your desktop, or as push notifications on your phone — even when Zocial isn't open. Requires your permission.",
  ...
  shownInNotificationsTab: 'Shown in the notifications tab',
  shownInNotificationsTabDescription: "Choose which kinds of activity appear in Zocial's notifications tab. This only affects the in-app list, not notifications sent to your device.",
