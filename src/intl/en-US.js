...
Enable this to also include the description text below the title.`,
  ...
  pushOneAccountTrigger: '(one account per device)',
  pushOneAccountPerDevice: 'Web Push allows a single subscription per device, so turning on OS push for another account moves it away from the current one.',
