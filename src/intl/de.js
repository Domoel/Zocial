export default {
  ...
  <p>
    Zocial ist eine statische Website, die überall gehostet werden kann (z. B. GitHub Pages). Sie wird als Docker-Image bereitgestellt und kann mithilfe eines Nginx-Webservers aufgesetzt werden. Alle Daten werden lokal in deinem Browser gespeichert und mit den Fediverse-Instanzen geteilt, mit denen du dich verbindest.
  </p>
